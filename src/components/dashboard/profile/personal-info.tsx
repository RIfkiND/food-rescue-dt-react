  ...
  return (
    <motion.section variants={fadeUp} className="md:col-span-7 lg:col-span-8 bg-white dark:bg-slate-900 rounded-[1rem] p-8 shadow-level-1 border border-gray-100 relative overflow-hidden">
      <div className="flex justify-between items-start mb-8">
        <div>
          <h2 className="font-h3 text-primary mb-1 text-2xl">Personal Information</h2>
          <p className="text-caption text-gray-400">Keep your details updated for a better experience</p>
        </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
        ...
        <div className="space-y-4">
          ...
          <div>
            <label className="block text-xs font-bold text-gray-400 uppercase tracking-widest mb-1">Account Type</label>
            <div className="inline-flex items-center gap-1 bg-primary/10 text-primary px-3 py-1 rounded-full">
              ...
              <span className="text-xs font-bold">Verified Individual</span>
            </div>
          </div>
        </div>
      </div>
