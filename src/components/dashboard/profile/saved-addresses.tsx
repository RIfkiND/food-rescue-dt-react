  ...
  return (
    <motion.section variants={fadeUp} className="md:col-span-12 bg-white dark:bg-slate-900 rounded-[1rem] overflow-hidden shadow-level-1 border border-gray-100">
      <div className="p-8 pb-4">
        <h2 className="font-h3 text-primary text-2xl">Alamat Tersimpan</h2>
      </div>
        ...
        <div className="p-8 border-r border-gray-50 flex flex-col justify-between">
          <div>
            <div className="flex items-center gap-2 mb-4">
              ...
              <span className="font-bold text-primary">Rumah</span>
              <span className="text-[10px] bg-emerald-50 text-emerald-700 px-2 py-0.5 rounded uppercase font-black">Utama</span>
            </div>
          ...
          <div className="flex gap-4">
            <button className="text-label-md text-gray-400 hover:text-primary transition-colors">Hapus</button>
            <button className="text-label-md text-primary font-bold hover:underline">Edit Detail</button>
          </div>
        </div>
