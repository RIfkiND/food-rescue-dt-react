    ...
    <motion.div variants={fadeUp} className="grid grid-cols-1 md:grid-cols-4 gap-6">
      <div className="bg-white p-6 rounded-xl shadow-level-1 border border-zinc-100">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-caption font-label-md text-outline uppercase tracking-wider">Active Listings</span>
        </div>
      ...
      <div className="bg-white p-6 rounded-xl shadow-level-1 border border-zinc-100">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-caption font-label-md text-outline uppercase tracking-wider">Total Rescued</span>
        </div>
      ...
      <div className="bg-white p-6 rounded-xl shadow-level-1 border border-zinc-100">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-caption font-label-md text-outline uppercase tracking-wider">Revenue Saved</span>
        </div>
        <p className="text-h2 font-h2 text-on-surface text-[32px] font-bold">$1,240</p>
      </div>
      ...
      <div className="bg-white p-6 rounded-xl shadow-level-1 border border-zinc-100">
        <div className="flex items-center gap-2 mb-2">
          ...
          <span className="text-caption font-label-md text-outline uppercase tracking-wider">Waste Avoided</span>
        </div>
