...
export function WelcomeSection() {
  return (
    <motion.header variants={fadeUp} className="mb-8 flex flex-col md:flex-row md:items-end justify-between gap-4">
      <div>
        <h1 className="font-h1 text-[40px] text-on-background">Welcome back, Green Bistro</h1>
        <p className="text-body-lg text-outline mt-2">Here's how your food rescue efforts are performing today.</p>
      </div>
